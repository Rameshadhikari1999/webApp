...
const Hero = () => {
  return (
    <div className="w-full h-screen lg:h-fit bg-gradient-to-r from-gray-500 via-gray-700 to-blue-200  relative">
      ...
      <div className="p-3 w-full mx-auto md:w-3/4 md:mx-auto absolute bottom-32 z-20">
